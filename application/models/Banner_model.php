...
class Banner_model extends CI_Model {
 ...
 ##------------------------------------------
	...
	public function addItem($data=array())
	{
	    ...
	    {
	    	$temp_data=array(
	    					'path'=>IMAGE_SRC_DIR.'media/user/'.$data['user_id'].'/image/banner/',
	    ...
	    {             
			$dbquery2=$this->db->conn_id->prepare("
							INSERT INTO `banner`(`user_id`,`item_pic`,`on_display`,`description`,`summary`,`type`) 
							VALUES(:user_id,:item_pic,:on_display,:description,:summary,:type)
			");
